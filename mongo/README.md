...
7. Verify installation inside the bin folder in the Command Prompt.
   ```bash
   mongoimport --version
8. Download `SFPL_Data_Fixed.zip` and extract the ZIP file to your desktop.
9. Drag the CSV file to your desktop.
10. Import the CSV file into MongoDB in the Command Prompt:
   ```bash
